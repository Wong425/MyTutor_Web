...
if (isset($_POST['submit'])) {
    ...
    $rgEmail = $_POST['email'];
    $rgPass = $_POST['password'];
    $rgAdd = $_POST['address'];
    $rgPhone = $_POST['phone'];
    $sqlinsertproduct = "INSERT INTO `tb_regis`(`name`, `email`, `password`, `address`, `phone`) VALUES 
    ('$rgName','$rgEmail','$rgPass','$rgAdd','$rgPhone')";
    try {
...
transition: all 200ms;
        ...
        .button:hover {background-color: #afe6c3;
...
<h2 style="font-weight:bold ">
    ...
    <div style="display:flex; justify-content: center">
        <div class="w3-white w3-container .form-container-reg w3-card w3-padding w3-margin" style="width:600px;margin:auto;text-align:left;border-radius: 20px;">
<p class="w3-center">
...
<form class="w3-container w3-padding formco" action="regis.php" method="post" enctype="multipart/form-data">
    ...
    <div class="w3-container w3-padding w3-center">
                <img class="w3-image inset w3-round w3-margin" src="../resources/profile2.png" style="height:100%;width:400px"><br>
    ...
    <p>
                ...
                <p>
                    ...
                    <textarea class="w3-input w3-round w3-border" type="address" name="address" id="idaddress" rows="4"  width="100%"placeholder="Your home address" required ></textarea>
                </p>
                <p>
                    <label><b>Phone Number</b></label>
                    <input class="w3-input w3-round w3-border" type="number" name="phone" id="idphone" placeholder="Your phone number" required>
                </p>
                <p>
...
<form class="w3-container w3-padding" name="register form"action="regis.php" method="post" onsubmit="return confirmDialog()" enctype="multipart/form-data" >
